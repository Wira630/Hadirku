    ...
    <div class="bg-white rounded-xl shadow-md p-6">
      ...
      <div class="mb-4">
        ...
        <div class="flex space-x-2">
          <select id="cameraSelect" class="flex-grow p-2 border border-gray-300 rounded-lg focus:ring-red-500 focus:border-blue-500">
            <option value="">-- Pilih Kamera --</option>
          </select>
          <button onclick="startScan()" class="px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 transition-colors flex items-center">
            <i class="fas fa-play mr-2"></i> Mulai
          </button>
        </div>
      </div>

      <div id="reader" class="border-4 border-red-500 rounded-lg w-full max-w-md aspect-square mx-auto overflow-hidden bg-gray-100 flex items-center justify-center">
      ...
      <div id="result" class="p-4 bg-red-50 rounded-lg border border-red-200 text-center mb-6 mt-4">
      ...
      <form id="presenceForm" method="POST" action="{{ route('scan.process') }}" class="hidden bg-white p-4 rounded-lg border border-gray-300 shadow-sm">
        ...
        <div class="mb-4">
          ...
          <select id="statusSelect" name="status" required class="w-full p-2 border border-gray-300 rounded-lg focus:ring-red-500 focus:border-red-500">
        ...
        <div class="mb-4">
          ...
          <textarea id="keterangan" name="keterangan" rows="3" placeholder="Masukkan keterangan tambahan..." class="w-full p-2 border border-gray-300 rounded-lg focus:ring-red-500 focus:border-red-500"></textarea>
        </div>
