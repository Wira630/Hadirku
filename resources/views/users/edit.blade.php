...
<body class="bg-gray-50 min-h-screen">
  ...
  <header class="bg-white shadow-md">
    <div class="max-w-7xl mx-auto px-4 py-3 sm:py-4 sm:px-6 lg:px-8 flex justify-between items-center">
      <div class="flex items-center space-x-3 sm:space-x-4">
        <a href="{{ route('users.index') }}" class="text-gray-600 hover:text-red-600 transition-colors" title="Kembali ke Daftar User">
  ...
  <div class="max-w-3xl mx-auto p-4 sm:p-6">
    ...
    <div class="bg-white rounded-lg shadow-lg overflow-hidden border border-gray-200">
      <!-- Card Header -->
      <div class="px-6 py-4 border-b bg-gradient-to-r from-red-600 to-red-700">
        ...
        <form action="{{ route('users.update', $user->id) }}" method="POST" class="space-y-6">
          ...
          <div class="flex items-center justify-end pt-6 border-t border-gray-200">
            <a 
              ...
              class="mr-4 inline-flex items-center px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500"
            >
