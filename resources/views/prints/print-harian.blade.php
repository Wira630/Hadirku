...
<body class="bg-gray-100 min-h-screen">
  ...
  <header class="bg-white shadow-sm no-print">
    <div class="max-w-7xl mx-auto px-4 py-3 sm:px-6 flex justify-between items-center">
      <div class="flex items-center space-x-3">
        <a href="{{ url('/') }}" class="text-gray-600 hover:text-gray-900 transition-colors" title="Kembali">
  ...
  <div class="print-header hidden bg-white py-4 border-b-2 border-red-600">
    <div class="text-center">
      ...
      <p class="text-md font-medium text-red-600">{{ $date }}</p>
    </div>
  </div>
      ...
      <div class="flex flex-col sm:flex-row items-start sm:items-end gap-4">
        <div class="w-full sm:w-auto">
          ...
          <input type="date" name="date" value="{{ $rawDate }}" 
                 class="w-full border border-gray-300 rounded px-3 py-2 text-sm focus:ring-red-500 focus:border-red-500">
        </div>
        <button type="submit" class="w-full sm:w-auto bg-red-600 hover:bg-red-700 text-white text-sm px-4 py-2 rounded">
      ...
      <div class="px-6 py-4 border-b bg-gray-50 no-print">
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          ...
          <div class="action-buttons">
            <button onclick="window.print()" class="action-btn bg-red-600 text-white hover:bg-red-700">
              ...
              <tr class="hover:bg-gray-50">
                ...
                <td class="px-4 py-3">
                  <span class="status-badge 
                    ...
                    {{ $attendance->status === 'izin' ? 'bg-red-100 text-red-800' : '' }}
